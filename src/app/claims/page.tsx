  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-3 sm:grid-cols-5 gap-2 sm:gap-4">
        ...
        <div className="text-center p-2 sm:p-3 bg-white rounded-lg border sm:block hidden">
          <div className="text-xs sm:text-lg font-bold font-mono">
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <Link
                        ...
                        className="font-mono font-medium text-sm text-blue-600 hover:text-blue-800 hover:underline"
                      >
          ...
          <div className="grid grid-cols-2 gap-4 mt-6 pt-4 border-t">
            <div className="text-center sm:text-left">
              ...
              <div className="text-sm font-bold text-green-600">
                SGD {stats.totalApproved.toFixed(2)}
              </div>
            </div>
