...
export default async function SubmitDraftPage({
  params,
}: SubmitDraftPageProps) {
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="bg-white border border-gray-300 p-6 mb-6">
          ...
          <div className="text-sm space-y-2">
            <div>
              <strong>Draft ID:</strong> CL-2024-
              {draft.id.toString().padStart(4, "0")}
            </div>
            <div>
            ...
            <div>
              ...
              {parseFloat(draft.totalAmount).toFixed(2)}
            </div>
            <div>
