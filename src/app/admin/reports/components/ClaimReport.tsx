...
function AttachmentImage({ url, alt }: { url: string; alt: string }) {
  ...
  if (hasError) {
    return (
      <div className="p-2 bg-gray-200 text-center text-xs text-gray-500 rounded">
        Image not available
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div
          id="report-content"
          className="bg-white border-2 border-black print:border-2 print:border-black"
        >
          {/* Invoice Header */}
          <div className="p-8 text-center border-b-2 border-black">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              Wild Dynasty Pte Ltd
            </h1>
            <p className="text-lg font-medium text-gray-700 mb-1">
              Expense Claim Audit Report
            </p>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>
                      {claim.createdAt
                        ? new Date(claim.createdAt).toLocaleDateString("en-SG")
                        : "N/A"}
                    </span>
                  </div>
                </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-gray-100 border-b border-black">
                    <TableHead className="border-r border-black font-semibold text-black">
                      Date
                    </TableHead>
                    <TableHead className="border-r border-black font-semibold text-black">
                      Item Type
                    ...
                    <TableHead className="text-right border-r border-black font-semibold text-black">
                      Amount
                    </TableHead>
                    <TableHead className="text-right border-r border-black font-semibold text-black">
                      Rate
                ...
                <TableBody>
                  {items.map((item, _index) => (
                    ...
                    >
                      ...
                      <TableCell>{item.evidenceNo || "N/A"}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
                <TableFooter>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="text-xs text-gray-500 mt-1">
                              {attachment.fileType} •{" "}
                              {Math.round(
                                parseFloat(attachment.fileSize) / 1024,
                              )}{" "}
                              KB
                            </p>
                          </div>
          ...
          <div className="p-6 bg-gray-50 border-t-2 border-black text-center">
            <p className="font-semibold text-gray-900">
              Wild Dynasty Pte Ltd - Expense Claim Audit Report
            </p>
            <p className="text-sm text-gray-600 mt-1">
              This report is generated for internal audit purposes only. All
              amounts are in Singapore Dollars (SGD).
            </p>
          </div>
        </div>
      </div>
